...
<html xmlns="http://www.w3.org/1999/xhtml"', $context['right_to_left'] ? ' dir="rtl"' : '', '><head>';
    ...
    <link rel="icon" type="image/png" href="https://ironnoob.net/favicon.png" />
...
function template_body_below()
{
	...
	<!-- <iframe style="float: left;" src="https://discord.com/widget?id=742520517336105010&theme=dark" width="350" height="500" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe> -->
<iframe style="float: left;" src="https://discord.com/widget?id=900274587521122325&theme=dark" width="350" height="500" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>

	
		<ul class="reset smalltext" style="display: none;">
